...
following Feature Sliced Design. The Flask backend lives in
[`back-end/`](back-end/) and the Next.js app lives in
[`front-end/`](front-end/).
...
All screenshots live in [`docs/media/`](docs/media/) and are regenerated by
[`front-end/scripts/capture-media.mjs`](front-end/scripts/capture-media.mjs).
...
```bash
# From the repo root, with the Docker stack up on :3000
node front-end/scripts/capture-media.mjs
```
...
| -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [front-end/src/README.md](front-end/src/README.md)                                                       | FSD architecture overview — layers, import rules, layer boundaries                                                                                                                                                          |
| [front-end/src/app/README.md](front-end/src/app/README.md)                                               | App layer: layout, page, globals.css, OG image, store persistence                                                                                                                                                           |
| [front-end/src/shared/README.md](front-end/src/shared/README.md)                                         | Shared layer overview — API client, utilities, logger, types                                                                                                                                                                |
| [front-end/src/shared/api/README.md](front-end/src/shared/api/README.md)                                 | API client: fetch wrapper, ApiError class, usage                                                                                                                                                                            |
| [front-end/src/shared/lib/README.md](front-end/src/shared/lib/README.md)                                 | Library modules: tax algorithm, currency formatter, logger, persisted store, test utils                                                                                                                                     |
| [front-end/src/entities/README.md](front-end/src/entities/README.md)                                     | Entity layer overview — business domain models                                                                                                                                                                              |
| [front-end/src/entities/tax-brackets/README.md](front-end/src/entities/tax-brackets/README.md)           | Tax brackets entity: store, events, effects, samples, selectors, Zod schemas                                                                                                                                                |
| [front-end/src/widgets/README.md](front-end/src/widgets/README.md)                                       | Widget layer overview — composed UI components                                                                                                                                                                              |
| [front-end/src/widgets/tax-calculator/README.md](front-end/src/widgets/tax-calculator/README.md)         | Tax calculator widget: components, sub-components, hooks, constants                                                                                                                                                         |
| [front-end/src/widgets/tax-calculator/lib/README.md](front-end/src/widgets/tax-calculator/lib/README.md) | Custom hooks: useCalculateAction, useCalculatorState, useRetryCalculation                                                                                                                                                   |
| [front-end/e2e/README.md](front-end/e2e/README.md)                                                       | E2E testing guide: Page Object Models, specs, Gherkin/BDD feature files                                                                                                                                                     |
...
| [docs/IMPLEMENTATION-PLAN.md](docs/IMPLEMENTATION-PLAN.md)                                               | Retrospective: execution status, user-requested enhancements, final checklist. Original forward-looking plan archived under `docs/archive/`.                                                                                |
...
Mermaid-based visualisations live under [`docs/diagrams/`](docs/diagrams/) and
render directly on GitHub, in VS Code with the Mermaid extension, or in any
...
| _custom logger_                        | —       | 60-line structured logger in `front-end/src/shared/lib/logger/logger.ts` — `console.*` wrapper with salary redaction, Pino-shaped numeric levels. Replaced the `pino` dependency in Phase 8.6 to correct an architectural-honesty claim about dependency bundle contribution. |
...
All npm scripts must be run from `front-end/`.
...
`front-end/src/shared/lib/test/test-utils.tsx` wires a forked scope into RTL
renders.
...
E2E tests live in `front-end/e2e/`. Playwright spins up the full Docker stack
...
map to Page Object Models in `front-end/e2e/pages/`. See
[front-end/e2e/README.md](front-end/e2e/README.md) for the full guide.
...
```
tax-calculator/
  back-end/           Flask tax calculator API
  front-end/
    src/
    ...
    scripts/          Standalone scripts (e.g. capture-media.mjs)
  ...
  docs/               Architecture, design system, onboarding, routes, diagrams, media
  docker-compose.yml  Full-stack Docker Compose topology
  docker-compose.dev.yml  Dev overlay for hot reload
```

See [front-end/src/README.md](front-end/src/README.md) for the full FSD layer
breakdown with import rules.
...
`no-restricted-imports` overrides in `front-end/eslint.config.mjs` — one for
each layer boundary, covering both the `#/` alias form and the relative-path
form. See [front-end/src/README.md](front-end/src/README.md) for the full layer
contract and the rule definitions.
...
- All theme configuration belongs in `front-end/src/app/globals.css` inside the
  `@theme inline` block
...
`front-end/src/shared/lib/logger/logger.ts`. Permitted: API calls, retry
attempts, errors, calculation results (total tax and effective rate only).
